...
from medperf.commands.fedtrain.submit import SubmitFederatedTraining
...
@clean_except
def list(
    local: bool = typer.Option(False, "--local", help="Get local federated trainings"),
    mine: bool = typer.Option(False, "--mine", help="Get current-user federated trainings"),
):
    """List federated trainings stored locally and remotely from the user"""
    EntityList.run(
        FederatedTraining,
...
@clean_except
def view(
    entity_id: Optional[int] = typer.Argument(None, help="Federated Training ID"),
    ...
    local: bool = typer.Option(
        False,
        "--local",
        help="Display local federated training if federated training ID is not provided",
    ),
    mine: bool = typer.Option(
        False,
        "--mine",
        help="Display current-user federated training if federated training ID is not provided",
    ),
    ...
    EntityView.run(entity_id, FederatedTraining, format, local, mine, output)
